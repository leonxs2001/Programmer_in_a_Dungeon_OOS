...
class Selector:
    ...
    def build(self):
        ...
        pygame.draw.rect(self.arrow_image, (0, 0, 0),
                         self.arrow_image_rect, width=2)
        center_y = Selector.arrow_size.y / 2
        pygame.draw.lines(self.arrow_image, (0, 0, 0), False, [
                          (0, 0), (Selector.arrow_size.x, center_y), (0, Selector.arrow_size.y)], width=3)
        ...
        pygame.draw.rect(self.background_image, (0, 0, 0),
                         pygame.rect.Rect((0, 0), (400, 720)), width=2)
        ...
        pygame.draw.rect(self.add_variabel_image, (0, 0, 0),
                         self.add_variabel_rect, width=2)
        ...
        if self.wait_for_input:
            ...
            if self.arrow_image_rect.collidepoint(mouse_position):
                ...
                if self.open:
                    ...
                    self.drawn_arrow_image = pygame.transform.rotate(
                        self.arrow_image, 180)
                else:
                    self.arrow_image_rect.left = 0
                    self.drawn_arrow_image = self.arrow_image.copy()
                    return True

...
class ValueBlock(Block):
    ...
    def __init__(self, name="add", representation="add", parameters=("Zahl1", "Zahl2")):
        background_color = (random.randint(100, 200), random.randint(
    ...
    def build(self):
        ...
        if len(self.parameters) > 0:
            ...
            for parameter in self.parameters:
                ...
                # can blit if the backgroundsurface exist
                texts.append((text.copy(), text_rect.copy()))
    ...
    def adjust_to_input_field(self, input_field):
        ...
        self.position = input_field.left_center - \
            (0, (ValueBlock.size_y * self.scale_factor) / 2)

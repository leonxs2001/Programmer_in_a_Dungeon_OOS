...
class SelectionInput:
    ...
    def build(self):
        ...
        pygame.draw.rect(self.frame_image, (70, 70, 70),
        ...
        self.text_rect.center = pygame.Vector2(
            200, 40) + self.frame_rect.topleft
        ...
        pygame.draw.rect(self.cancel_button, (0, 0, 0),
                         self.cancel_button_rect, width=2)
        ...
        self.cover_up_rect = pygame.rect.Rect(
            self.scroll_background_rect.left, 0, self.scroll_background_rect.width, 60)
    ...
    def check_collision(self, mouse_position: pygame.Vector2):
        ...
        if self.cancel_button_rect.collidepoint(mouse_position):
            return True
                ...
                if self.selection_buttons[0][1].top + scrollment > max:
                    ...
                    if len(self.selection_buttons) >= 5:
                        if self.selection_buttons[-1][1].bottom + scrollment < max2:
                            scrollment = max2 - \
                                self.selection_buttons[-1][1].bottom
                    elif scrollment < 0:
                        scrollment = 0
    ...
    def draw(self, screen: pygame.Surface):
        ...
        pygame.draw.rect(screen, (0, 0, 0),
                         self.scroll_background_rect, width=3)
